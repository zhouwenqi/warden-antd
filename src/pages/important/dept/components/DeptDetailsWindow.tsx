...
export interface DeptDetailsWindowProps extends WindowProps {
    data?:DeptData;
    onEdit?:(data:DeptData)=>void
}
 ...
 * @returns 
 */
const DeptDetailsWindow = (props:DeptDetailsWindowProps)=>{
    const intl = useIntl()  
...
export default DeptDetailsWindow